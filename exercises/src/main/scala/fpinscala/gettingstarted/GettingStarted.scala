...
object PolymorphicFunctions {
  ...
  def isSorted[A](as: Array[A], gt: (A,A) => Boolean): Boolean = {
    def go(as: Array[A], i: Int, gt: (A, A) => Boolean): Boolean = {
  ...
  */
  ...
  def main(args: Array[String]): Unit = {
    println("Expect: true, true, false")
    println("Actual: %b, %b, %b".format(isSorted(Array(1, 2, 3, 4, 5), (a: Int, b:Int) => a > b),
      isSorted(Array(1, 2, 10, 11, 20), (a: Int, b:Int) => a > b),
      isSorted(Array(1, 2, 3, 2, 5), (a: Int, b:Int) => a > b)))
  }
}
